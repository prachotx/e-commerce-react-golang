                ...
                <Wrapper>
                    <div className="flex justify-between h-[900px] text-white relative">
                        <div className="max-w-[50%] h-[300px] mt-[200px]">
                            ...
                            <form onSubmit={handleSubmit} className="flex justify-between mt-16 pl-7 bg-white w-[450px] rounded-[25px] shadow">
                                <input value={search} onChange={(event) => setSearch(event.target.value)} type="text" className="text-sm text-black outline-none" placeholder="Type Something" required />
                ...
                <Wrapper>
                    <div>
                        ...
                        <div className="flex justify-between">
                            ...
                            <Button name={"View All"} path={"/products"} />
                        </div>
